...
from ..proto.proxy.mtproto.config_pb2 import Account as MTProtoAccountPb2
...
class MTProtoAccount(Account):
    secret: str

    @property
    def message(self):
        return Message(MTProtoAccountPb2(secret=bytes.fromhex(self.secret)))
